...
main:
    ...
    LH R0, write_data   ; R0 = address of write_data
    LH R1, 0            ; R1 = counter for string length
    LH R2, 0            ; R2 = null terminator to compare against
...
count_done:
    ...
    LH R0, filename     ; R0 = address of filename
    LH R1, 1            ; R1 = 1 (write mode)
    ...
    LH R1, write_data   ; R1 = address of data to write
    ...
    LH R0, filename     ; R0 = address of filename
    LH R1, 0            ; R1 = 0 (read mode)
    SYS R0, 0x0100        ; FILE_OPEN system call
    MOV R7, R0            ; Save file descriptor in R7
    
    ; Step 5: Read data from file
    MOV R0, R7            ; R0 = file descriptor
    LH R1, read_buffer  ; R1 = address of buffer to read into
    ...
    LH R0, read_buffer  ; R0 = address of read buffer
    MOV R2, R6            ; R2 = counter (calculated string length)
    LH R3, 1            ; R3 = constant 1 for decrementing
    LH R4, 0            ; R4 = constant 0 for comparison
